...
public class ActiveInventory : MonoBehaviour
{
    ...
    private void ChangeActiveWeapon()
    {
        ...
        GameObject weaponToSwawn = transform.GetChild(activeSlotIndexNum).GetComponentInChildren<InventorySlot>().GetWeaponInfo().weaponPrefab;
        GameObject newWeapon = Instantiate(weaponToSwawn,ActiveWeapon.Instance.transform.position,Quaternion.identity);
